...
track <- readRDS('./nasal/track.rds') # figure 1
phylo_decontam_rar <- readRDS("./nasal/phylo_decontam_rar.rds") # figure 2, 3, 5, 6
clean_phylo_rarified <- readRDS("./nasal/clean_phylo_rarified.rds") # figure 2
phylo_species_then_decontam_rar <- readRDS("./nasal/phylo_species_then_decontam_rar.rds") # figure 3
chisq_summary <- readRDS("./nasal/chisq_summary.rds") # figure 4
patient_data_correlation_summary <- readRDS("./nasal/numeric_patient_data_correlation_summary.rds") # figure 4
phylo <- readRDS("./nasal/phylo.rds") # figure 7
phylo.coreW_25 <- readRDS("./nasal/phylo.coreW_25.rds") # figure 8
atb_phylo.coreW_35 <- readRDS("./nasal/atb_phylo.coreW_35.rds") # figure 9
no_atb_phylo.coreW_35 <- readRDS("./nasal/no_atb_phylo.coreW_35.rds") # figure 9
core_SVs_sig_diff_on_wilcox_test <- readRDS("./nasal/core_SVs_sig_diff_on_wilcox_test.rds") # figure 9
wilcox_sig_SVs <- readRDS("./nasal/wilcox_sig_SVs.rds") # figure 10
sigtab <- readRDS("./nasal/sigtab.rds") # figure 12
